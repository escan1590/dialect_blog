            ...
            <Grid container>
              <Grid item xs={2} className={classes.putToLeft}>
                {modifying ? (
                  ...
                  <>
                    <IconButton aria-label="upvote this post">
                      <ThumbUpIcon />
                    </IconButton>
                    <IconButton aria-label="downvote this post">
                      <ThumbDownIcon />
                    </IconButton>
                  </>
                )}
              ...
              <Grid item xs={2} className={classes.putToRight}>
                {modifying ? (
                  <>
                    <IconButton aria-label="Cancel Modification">
                      <CancelIcon
                        // onClick={handleCancelModification}
                        color="error"
                      />
                    </IconButton>
                    <IconButton aria-label="Save Modification">
                      <SaveIcon
                        // onClick={handleEndModification}
                        color="primary"
                      />
